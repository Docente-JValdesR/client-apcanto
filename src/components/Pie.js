        ...
        <div className="d-flex align-items-center">
          <div className="container">
            ...
            >
              ...
              <div className="col-12 col-md-6 order-0 order-md-1 text-md-end">
              ...
              <div className="col-12 col-md-6 order-2 text-md-start">
                <h2>Lorem ipsum dolor sit amet consectetur.</h2>
                <p>
              ...
              <div className="col-12 col-md-4 order-5 order-md-4">
                <div className="card border-secondary text-bg-secondary mb-3">
                  <img
              ...
              <div className="col-12 col-md-6 order-4 order-md-5 text-md-end">
